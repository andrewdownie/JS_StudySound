...
///     - called when the navbar is loaded
    ...
    backStack[0].name = "StudySound.JS"
    ...
    $("table").each(function(index){
       ...
       $(this).prevAll("h1").first().each(function(index){
        ...
        $(this).find("tr td p").each(function(index){
            ...
            newContents += '<input class="col-xs-2 btn btn-default" onclick=\'responsiveVoice.speak("' + $(this).text() + '", "US English Female");\' type="button" value="Play" />'
            newContents += '</div>'
            newContents += '<br/>'
        });
